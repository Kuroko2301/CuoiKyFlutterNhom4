                      ...
                      switch (snapshot.connectionState){
                        ...
                        case ConnectionState.done:
                          ...
                          if(_list.isNotEmpty){
                            ...
                            return const Center(child: Text('Hãy nói chào! 👋', style: TextStyle(fontSize: 20),),);
                          }
                      }
                    },
              ...
              children: [
                ...
                Text(
                  list.isNotEmpty
                      ? list[0].isOnline
                        ? 'Đang hoạt động'
                        : MyDayUtil.getLastActiveTime(context: context, lastActive: list[0].lastActive)
                      : MyDayUtil.getLastActiveTime(context: context, lastActive: widget.user.lastActive),
                  style: const TextStyle(
                    fontSize: 13,
